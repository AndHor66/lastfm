...
$("#last a").attr("href", "http://www.last.fm/user/"andhor"/now");

$.get( "http://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=" + andhor + "&api_key=1f633977acf0e2d0630ec11dbc350d3e&format=json", function( data ) 
{
